    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 max-w-[1200px]">
        ...
        <div className="text-center mb-16 md:mb-24">
          <h2 className="text-4xl md:text-5xl lg:text-6xl text-text-0 mb-4">
            How LUCI Works
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 bg-accent/25 -translate-x-1/2" />

          {/* Vertical Timeline Line - Mobile/Tablet */}
          <div className="lg:hidden absolute left-5 md:left-10 top-0 bottom-0  bg-accent/25" />
