...
const comparisons = [
  {
    ...
    title: "Review a company you met 3 months ago",
    without:
      "Search through emails, Slack threads, and notes apps. Ask your associate \"what was that fintech startup again?\"",
    withLuci:
      "Search the founder's name — every meeting note, deck highlight, and follow-up action in one profile.",
    metric: { before: "45 min", after: "5 sec" },
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Get portfolio company updates for LP meeting",
    without:
      "Chase 12 founders for updates. Half reply late. Manually compile a deck from scattered data.",
    withLuci:
      "Auto-aggregated dashboard: revenue, runway, milestones — updated from every communication channel.",
    metric: { before: "2 days", after: "Instant" },
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Run due diligence on a new deal",
    without:
      "Analyst spends days cross-referencing claims, building comp tables, and drafting a memo from scratch.",
    withLuci:
      "Structured brief auto-generated: market analysis, flag inconsistencies, comparable exits — IC-ready.",
    metric: { before: "3 days", after: "3 min" },
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Keep deal flow and LP data secure",
    without:
      "Sensitive deal terms scattered across Google Docs, WhatsApp, and email — no access controls.",
    withLuci:
      "Self-hosted, encrypted, and auditable. Deal data stays in your environment with full access control.",
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-20 py-20 md:py-32">
        ...
        <div className="text-center mb-14 md:mb-20">
          ...
          <p className="mt-4 text-[15px] text-text-2 max-w-[520px] mx-auto leading-relaxed">
            See how everyday investment tasks transform — from time-consuming busywork to instant insight.
          </p>
        </div>
