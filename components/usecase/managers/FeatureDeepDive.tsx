...
const features = [
  {
    title: "Automated Video Understanding",
    desc: "No more manual tagging. LUCI identifies key concepts and visuals automatically — turning hours of raw footage into structured, searchable knowledge in seconds.",
    bg: "/landscape/lan2.webp",
  },
  {
    title: "Got a question? Just ask LUCI",
    desc: "Search across all your meetings and videos in plain language. Ask who said what, find key moments, or get instant summaries — no digging through recordings.",
    bg: "/landscape/lan7.webp",
    reverse: true,
  },
  {
    title: "Unlimited Video Memory",
    desc: "No more manual tagging. LUCI identifies key concepts and visuals automatically — turning hours of raw footage into structured, searchable knowledge in seconds.",
    bg: "/landscape/lan4.webp",
  },
  {
    title: "Cross-Platform Knowledge Integration",
    desc: "Sync notes from TikTok, YouTube, and internal meetings into one unified team knowledge base. No more scattered docs — everything lives in one place.",
...
const actionItems = [
  { text: "Review the meeting agenda and objectives", done: true },
  { text: "Distribute pre-reading materials to participants", done: true },
  { text: "Send out post-meeting summary to attendees", done: false },
  { text: "Schedule follow-up with marketing team", done: false },
];
          ...
          <div className="flex flex-col gap-3 px-4 py-3">
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[11px] leading-relaxed text-text-1">
                This meeting covered the Q3 marketing strategy, focusing on
                leveraging AI for personalized customer experiences. Key
                discussion points included the integration of WhisperFlow and
                the development of targeted content campaigns. Action items were
                assigned to enhance user engagement and optimize marketing ROI.
              </p>
            </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-16 md:py-28">
        ...
        <div className="flex flex-col gap-4 mb-16">
          <h2 className="text-[28px] md:text-[40px] font-semibold leading-tight text-center text-text-0">
            How LUCI Helps Managers Win
          </h2>
          <p className="text-base text-text-2 max-w-2xl mx-auto text-center leading-relaxed">
            From automated video tagging to cross-platform knowledge sync, LUCI
